    ...
    <div class="app-container">
        ...
        <el-card class="box-card" uno-margin-top>
            <el-table v-loading="state.loading" :data="state.tableData" style="width: 100%" show-summary
                ...
                <el-table-column prop="nickname" label="用户名" header-align="center" :align="'center'" width="180">
...
import { recharge_achieve_log_post } from "@/api/logrecordManagement"
...
const getData = async () => {
    ...
    recharge_achieve_log_post({ ...state.pageForm }).then(res => {
