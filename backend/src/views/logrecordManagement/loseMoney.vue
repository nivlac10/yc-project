  ...
  <div class="app-container">
    ...
    <el-card class="box-card" uno-margin-top>
      <el-table v-loading="state.loading" :data="state.tableData" style="width: 100%;">
        ...
        <el-table-column prop="loss_money" label="用户输赢" header-align="center" :align="'center'" />
        <el-table-column prop="add_time" label="领取时间" header-align="center" :align="'center'" />
        <el-table-column prop="give_money" label="领取金额" header-align="center" :align="'center'" />
      </el-table>
    </el-card>
...
import { user_loss_bonus_log_post } from "../../api/logrecordManagement";
...
const getData = async () => {
  ...
  user_loss_bonus_log_post({ ...state.pageForm }).then(res => {
