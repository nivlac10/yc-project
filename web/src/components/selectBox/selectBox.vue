<template>
  <div class="selectBox">
    <div class="select_box_column">
      <input :class="{ active: selectActive }" type="text" :value="input" readonly @focus="inputFocus" :placeholder="(props.options as any)[0].label"
        @blur="inputBlur" />
      <div class="icon">
...
.selectBox {
  ...
  .select_box_column {
    ...
    input {
      ...
      border: 2px solid var(--auxiliary-background-20);
      border-radius: 12px;
