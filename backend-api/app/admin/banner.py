...
# 获取列表
@admin.route('/admin/banner_list_post', methods=['post'])
@login_required
...
# 禁用轮播图
@admin.route('/admin/update_banner_status_post', methods=['post'])
@login_required
...
# 添加轮播图
@admin.route('/admin/add_banner_post', methods=['post'])
@login_required
def add_banner_post():
    data = dict()
    data['code'] = 0
...
# 修改轮播图
@admin.route('/admin/detail_banner_post', methods=['post'])
@login_required
...
# 删除轮播图
@admin.route('/admin/delete_banner_post', methods=['post'])
@login_required
